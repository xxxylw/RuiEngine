...
class VulkanConfiguration:
    ...
    installVulkanVersion = "1.4.328"
    vulkanDirectory = "./RuiEngine/vendor/VulkanSDK"
    ...
    def CheckVulkanSDK(cls):
        ...
        #     print(f"You don't have the correct Vulkan SDK version! (Engine requires {cls.requiredVulkanVersion}) {vulkanSDK}")
        #     cls.__InstallVulkanSDK()
        #     return False
