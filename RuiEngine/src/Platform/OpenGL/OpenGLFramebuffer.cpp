...
namespace RuiEngine {
	...
	namespace Utils {
		...
		static GLenum HazelFBTextureFormatToGL(FramebufferTextureFormat format)
		{
			...
			RE_CORE_ASSERT(false, "Unknow FramebufferTextureFormat");
			return 0;
		}
	}
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		{
			RE_CORE_ASSERT(m_ColorAttachments.size() <= 4, "m_ColorAttachments.size() must M= 4");
	...
	{
		RE_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size(), "attachmentIndex should < m_ColorAttachments.size()");
	...
	{
		RE_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size(), "Should : attachmentIndex < m_ColorAttachments.size()");
