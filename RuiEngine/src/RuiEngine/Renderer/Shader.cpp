...
namespace RuiEngine {
	RuiEngine::Shader::Shader(const std::string& vertexSrc, const std::string& fragmentSrc)
	{
		...
		if (isCompiled == GL_FALSE)
		{
			...
			// We don't need the shader int file
		...
		// Always detach shaders int after a successful link.
