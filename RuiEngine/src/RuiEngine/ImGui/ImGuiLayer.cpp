...
#include "imgui.h"
#include "RuiEngine/Platform/OpenGL/ImGuiOpenGLRenderer.h"
...
namespace RuiEngine {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY: should eventually use RuiEngine key codes
	...
	bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& e)
	{
		...
		io.KeyCtrl = io.KeysDown
			[GLFW_KEY_LEFT_CONTROL] || io.KeysDown[GLFW_KEY_RIGHT_CONTROL];
		io.KeyShift = io.KeysDown
			[GLFW_KEY_LEFT_SHIFT] || io.KeysDown[GLFW_KEY_RIGHT_SHIFT];
		io.KeyAlt = io.KeysDown
			[GLFW_KEY_LEFT_ALT] || io.KeysDown[GLFW_KEY_RIGHT_ALT];
		io.KeySuper = io.KeysDown
			[GLFW_KEY_LEFT_SUPER] || io.KeysDown[GLFW_KEY_RIGHT_SUPER];
