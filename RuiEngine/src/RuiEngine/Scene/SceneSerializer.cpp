...
namespace RuiEngine {
	...
	static void SerializeEntity(YAML::Emitter& out, Entity entity)
	{
		...
		RE_CORE_TRACE("Entity.GetUUID() : {0}", (uint64_t)entity.GetUUID());
	...
	{
		// Not implemented
		RE_CORE_ASSERT(false, "SerializeRuntime not implement");
	}
	...
	{
		RE_CORE_ASSERT(false, "DeserializeRuntime not implement");
		return false;
	}
}
